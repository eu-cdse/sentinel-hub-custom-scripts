...
Detect changes of water body extent between two Landsat 8-9 Level-1 images. The water body detection is simply based on a MNDWI threshold.
...
function setup() {
  return {
    input: [
      {
        datasource: "LANDSAT_OLDER",
        bands: ["B03", "B06", "dataMask"],
      },
      {
...
function evaluatePixel(samples) {
  const s1 = samples.LANDSAT_OLDER[0];
