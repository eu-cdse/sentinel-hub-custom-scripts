...
The mixture used for green was chosen to keep Red and Blue dominant while keeping a pleasant overall palette of colours. Our solution is to use a variant of the Soft Light blend mode as described in the [Pegtop software documentation](https://www.pegtop.net/delphi/articles/blendmodes/softlight.htm) or the [Gimp documentation](https://docs.gimp.org/en/gimp-concepts-layer-modes.html) (as Overlay), with HH as the top layer and HV as the bottom layer. It translates in our case to:
