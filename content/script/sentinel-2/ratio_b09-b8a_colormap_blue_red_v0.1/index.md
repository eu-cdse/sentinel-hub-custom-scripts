...
The RED-BLUE color table is inspired by [NDMI](https://custom-scripts.sentinel-hub.com/sentinel-2/ndmi/) with different breakpoints.

[The Hollstein cloud detection](https://custom-scripts.sentinel-hub.com/sentinel-2/hollstein/) is used to identify CLEAR land pixels. Band B8A is used for (B09 / B8A) ratio computation as B8A spectral response is narrower than band B08 and therefore closest to band B09.
...
[1] The RED-BLUE color table is inspired by [NDMI](https://custom-scripts.sentinel-hub.com/sentinel-2/ndmi/) with different breakpoints.

[2] [The Hollstein cloud detection](https://custom-scripts.sentinel-hub.com/sentinel-2/hollstein/) is used to identify CLEAR land pixels.
