...
function evaluatePixel(samples) {
  ...
  let water_plants = (samples.B05 - samples.B04)/(samples.B05 + samples.B04);
  let NIR2 = samples.B04 + (samples.B11 - samples.B04)*((832,8 - 664,6)/(1613,7 - 664,6));
  ...
  if (NDWI < 0 && water_bodies > 0) return [...natural_color, samples.dataMask];
