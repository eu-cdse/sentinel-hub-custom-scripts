...
function evaluatePixel(sample) {
    ...
    var NATURAL_REDGE = [
        sample.B04 * 4.0,
        sample.B03 * 2.8 + sample.B06 * 1.5,
        sample.B02 * 3.5,
    ]; // Near Natural; turbidity and algae RedEdge
    ...
    var NATURAL_NIR = [
        sample.B04 * 3.0 + sample.B05 * 1.0,
        sample.B03 * 3.0 + sample.B08 * 1.0,
        sample.B02 * 3.5,
    ]; // Near Natural; Vegetation NIR
