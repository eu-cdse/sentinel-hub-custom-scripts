...
function evaluatePixel(samples) {
  ...
  var band1 = brightness * (stretch(samples.B09, 0, 0.25) - 0.1 * stretch(samples.B14, 0, 0.1));
  var band2 = brightness * (1.1 * stretch(samples.B06, 0, 0.25) - 0.1 * stretch(samples.B14, 0, 0.1));
  var band3 = brightness * (stretch(samples.B04, 0, 0.25) - 0.1 * stretch(samples.B14, 0, 0.1) + .01 * stretch(index, 0.5, 1));
